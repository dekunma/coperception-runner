...
def main(config,args):
    ...
    # TODO: kd_flag
    valset = V2XSimSeg(dataset_roots=[args.data+'/agent%d'%i for i in agent_idx_range], config=config, split ='val',val=True, com=args.com, bound=args.bound, no_cross_road=args.no_cross_road)
